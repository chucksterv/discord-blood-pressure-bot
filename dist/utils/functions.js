...
*/
export async function getRawReadings(userId, startDate, endDate) {
 ...
 */
export function extractReadingValues(rawReading) {
    ...
    if (systolic === null || diastolic === null || arm === null)
        return null;
    return {
        systolic: systolic,
        diastolic: diastolic,
...
/**
   ...
   */
export function calculateDateRange(timeframe, timezone, referenceDate = null) {
...
/**
  ...
  */
export async function getAverages(userId, timeframe, timezone, referenceDate = null) {
...
/**
   ...
   */
export async function getSummary(userId, timezone) {
 ...
 */
export async function getDailyAveragesRange({ userId, timezone, startDate, endDate }) {
 ...
 */
export async function getWeeklyAveragesRange({ userId, timezone, startDate, endDate }) {
 ...
 */
export async function getMonthlyAveragesRange({ userId, timezone, startDate, endDate }) {
